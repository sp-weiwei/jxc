...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/common.js"></script>
	...
	<script type="text/javascript">
        ...
        function goodsModify(){
            ...
            $("#fm").form("load",row);
            url="${pageContext.request.contextPath}/goods/save.do?id="+row.id;
        }
	...
	url="${pageContext.request.contextPath}/goods/list.do" fit="true" toolbar="#tb">
        <thead>
			<tr>
                ...
                <th field="outPrice" width="80" align="center">售价(元)</th>
                <th field="stockDate" width="80" align="center" hidden="true">进货日期</th>
                ...
                <th field="wareHouse" width="50" align="center" formatter="formatWareHouse">所在仓库</th>
        ...
        <form id="fm" method="post">
            <table style="margin: 5px" cellpadding="8px">
                ...
                <tr>
                    ...
                    <td>仓  库：</td>
                    <td><input class="easyui-combobox" id="wareHouseId" name="wareHouse.id" data-options="panelHeight:'80',editable:false,valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/wareHouse/findAll.do'"/></td>
                </tr>
                <tr>
                    <td>备   注：</td>
