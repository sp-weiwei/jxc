	...
	url="${pageContext.request.contextPath}/user/list.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
                ...
                <th field="role" width="100" align="center" formatter="formateRole">电话</th>
			</tr>
		</thead>
	</table>
        ...
        <form id="fm" method="post">
            <table>
                ...
                <tr>
                    <td>角色：</td>
                    <td>
                        <select class="easyui-combobox" style="width: 154px" id="roleId" name="roleId" editable="false" panelHeight="auto" required="true">
                            <option value="">请选择...</option>
                            <option value="1">管理员</option>
                            <option value="2">经理</option>
                            <option value="3">采购主管</option>
                            <option value="4">销售主管</option>
